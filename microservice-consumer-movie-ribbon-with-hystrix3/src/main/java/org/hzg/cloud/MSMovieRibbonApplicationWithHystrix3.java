...
public class MSMovieRibbonApplicationWithHystrix3 {
   ...
   *
   * 本例和movie-ribbon-with-hystrix3连用，目的是在一个服务中配置两个端口，用来把管理端口和服务的基础端口分开
   * @return
   */
  @Bean
  @LoadBalanced
  ...
  public static void main(String[] args) {
    SpringApplication.run(MSMovieRibbonApplicationWithHystrix3.class, args);
  }
}
