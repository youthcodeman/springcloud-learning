...
public class MSMovieRibbonApplicationWithHystrix2 {
   ...
   *
   * 本例和movie-ribbon-with-hystrix连用，目的地为了自定义服务的根路径，然后用turbine来监控服务的情况
   * @return
   */
  @Bean
  @LoadBalanced
  ...
  public static void main(String[] args) {
    SpringApplication.run(MSMovieRibbonApplicationWithHystrix2.class, args);
  }
}
